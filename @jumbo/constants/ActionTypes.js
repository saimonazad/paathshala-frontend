...
export const ALL_PERSONAL_FEEDS_SUCCESS = "ALL_PERSONAL_FEEDS_SUCCESS";
export const ALL_PERSONAL_FEEDS_FAIL = "ALL_PERSONAL_FEEDS_FAIL";

export const CREATE_PERSONAL_FEEDS_SUCCESS = "CREATE_PERSONAL_FEEDS_SUCCESS";
//courses create/get
export const CREATE_COURSE_SUCCESS = "CREATE_COURSE_SUCCESS";
export const ALL_PERSONAL_COURSE_SUCCESS = "ALL_PERSONAL_COURSE_SUCCESS";
...
export const CREATE_COURSE_FEEDS_SUCCESS = "CREATE_COURSE_FEEDS_SUCCESS";
export const ALL_COURSE_FEEDS_SUCCESS = "ALL_COURSE_FEEDS_SUCCESS";
